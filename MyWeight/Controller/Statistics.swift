...
class Statistics: UITableViewController {
    
    
    var cellArray: [CellModel] = []
    //adding some temporary hardcoaded items
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "WeightCell", for: indexPath) as! StatisticsViewController
